...
#SBATCH -J soma1_shift
#SBATCH -o soma1_shift.%j.out
#SBATCH -e soma1_shift.%j.err
#SBATCH -N 1
#SBATCH -n 4
#SBATCH -t 48:00:00
...
workdir=$scratchdir/run_vary_winds4_and_SST_change_max_monthly_tau_dev_C
...
#----- pickups ---------------
ln -s /scratch/shoshi/soma/run_vary_winds_0.1_0.5_cos_100yrs_redo/pickup.0002592000.data pickup.0000000001.data
ln -s /scratch/shoshi/soma/run_vary_winds_0.1_0.5_cos_100yrs_redo/pickup.0002592000.meta pickup.0000000001.meta
