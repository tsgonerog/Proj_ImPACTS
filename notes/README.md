...
| [`tapenade_hooks/`](tapenade_hooks/) | Change note on replacing the TAF hook directives with Tapenade-native active-argument hooks (`ADJ*` dumps + adjViscBoost mode switching): the gap, the mechanism, a file-by-file comparison, bitwise validation, and upstream-MITgcm considerations. Written 2026-08-31 for advisor/MITgcm review; a styled HTML copy sits beside the README |
