...
%  analyses/DINO_1deg/adjoint/kappa_v_ensemble/ (seven executed
%  notebooks; summary tables under analysis/kappa_v_ensemble/stats/ on
...
and again on 2026-09-02 as jobs 31060--31067 with the profile-guided
\code{-nocheckpoint} build that became the default that day, bitwise
identical to 31039--31046 in every output and $1.5\times$ faster.
...
\code{analyses/DINO\_1deg/adjoint/}\allowbreak\code{kappa\_v\_ensemble/}
...
\code{analysis/kappa\_v\_ensemble/} on scratch. This section states the
...
\code{inAd*} parameters was never called; the Tapenade mode-switch hooks
(\code{AUTODIFF\_INADMODE\_SET/UNSET}, named \code{TAP\_INADMODE\_*} until
2026-09-02) have since made it functional, first working boosted run 31025, so
this remedy is now actually available.)
