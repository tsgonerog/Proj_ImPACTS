...
#SBATCH -J bcgyre_tapAdj_test    # Set job name once here
...
# === Define key paths ===
home_dir=/home/tshahriar/Proj_ImPACTS/MITgcm_c69c/tutorial_baroclinic_gyre_with_adj
build_dir=$home_dir/build_tapAdj_parallel
input_dir=$home_dir/input_tap
run_dir=/scratch2/tshahriar/verification_tutorials_run/${job_name}_run$SLURM_JOB_ID  # unique per job
