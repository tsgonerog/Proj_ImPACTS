...
CEOP
      ...
      INTEGER ny
      INTEGER nr
      PARAMETER (snx=31, sny=31, olx=4, oly=4, nsx=1, nsy=1, npx=2, npy=
     +   2, nx=snx*nsx*npx, ny=sny*nsy*npy, nr=31)
C
...
C                      concentration and can change with space and time.
      ...
      COMMON /seaice_sw_r/ seaice_swfrac
C
CEH3 ;;; Local Variables: ***
CEH3 ;;; mode:fortran ***
CEH3 ;;; End: ***
...
C ====== BEGIN manual I/O: forward fields (hfacc, theta, salt) ======
      OPEN(unit=500, file='hFacC_v4_soma.data', form='formatted', status='replace', action='write')
      OPEN(unit=501, file='theta_v4_soma.data', form='formatted', status='replace', action='write')
      OPEN(unit=502, file='salt_v4_soma.data' , form='formatted', status='replace', action='write')
      DO ii1=1,nsy
        DO ii2=1,nsx
          DO ii3=1,nr
...
C ====== BEGIN manual I/O: adjoint fields (thetab, saltb) ======
      OPEN(unit=503, file='thetab_v4_soma.data', form='formatted', status='replace', action='write')
      OPEN(unit=504, file='saltb_v4_soma.data' , form='formatted', status='replace', action='write')
      DO ii1=1,nsy
        DO ii2=1,nsx
          DO ii3=1,nr
            DO ii4=1-oly,oly+sny
