# Adjoint run comparison — REF, 31055 vs 31060 (nocheckpoint executable rebuilt 2026-09-02 vs the 2026-09-01 one)
- reference: `DINO_1deg_tapAdj_nocheckpoint_5yr_from180yrPk_visc2x_run31055` *(deleted 2026-09-03; it was bitwise identical to the reference, so this report is the record)*
- test:      `DINO_1deg_tapAdj_nocheckpoint_5yr_from180yrPk_visc2x_run31060` *(deleted 2026-09-03; it was bitwise identical to the reference, so this report is the record)*

## Runtime
| run | wall time | seconds | forward sweep | reverse sweep |
|---|---|---|---|---|
| reference | 09:35:58 | 34558 | 00:50:38 | 08:45:19 |
| test | 09:44:50 | 35090 | 00:50:51 | 08:53:58 |

speed-up (ref/test) = **0.985x**, time saved = -1.5 %
reverse-sweep speed-up = 0.984x, forward sweep 3038 s vs 3051 s
