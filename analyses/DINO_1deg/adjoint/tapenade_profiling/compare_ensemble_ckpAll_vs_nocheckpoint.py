...
analyses/DINO_1deg/adjoint/kappa_v_ensemble/) were run on 2026-09-01
...
# the eight ensemble adjoints are one campaign under runs/adjoint/
SCRATCH = Path("/scratch2/tshahriar/DINO_1deg_outputs/runs/adjoint/kappa_v_ensemble")
