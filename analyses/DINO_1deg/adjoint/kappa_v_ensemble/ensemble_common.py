...
Conventions carried over from adjoint/sensitivity_5yr_from180yrPk_visc2x.ipynb:
...
# Scratch is organised as <setup>_outputs/{runs/{forward,adjoint}/<campaign>,
# analysis/<campaign>, executables, logs}. The eight adjoints of this ensemble
# are one campaign; SCRATCH points at that campaign directory, and everything
# this suite writes goes under the matching analysis/ campaign.
OUTPUTS = Path("/scratch2/tshahriar/DINO_1deg_outputs")
SCRATCH = OUTPUTS / "runs" / "adjoint" / "kappa_v_ensemble"
FWD_SCRATCH = OUTPUTS / "runs" / "forward" / "kappa_v_ensemble"
SPINUP_SCRATCH = OUTPUTS / "runs" / "forward" / "spinup_200yr_visc2x"
ANALYSIS_ROOT = OUTPUTS / "analysis" / "kappa_v_ensemble"
