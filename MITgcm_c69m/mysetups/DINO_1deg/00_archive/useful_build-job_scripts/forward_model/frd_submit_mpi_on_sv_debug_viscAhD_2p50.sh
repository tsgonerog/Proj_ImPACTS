...
#SBATCH -J debug_tr12     # Set job name once here
...
run_dir="/scratch2/tshahriar/DINO_MITgcm_v011526_frd_runs/${job_name}_73200d_viscAhD_2p50_run$SLURM_JOB_ID"  # unique per job
...
rm data
mv data_debug_viscAhD_2p50 data
