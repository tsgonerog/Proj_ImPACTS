...
#SBATCH -J debug_tr6     # Set job name once here
...
run_dir="/scratch2/tshahriar/DINO_MITgcm_v011526_frd_runs/${job_name}_720000d_adv30FromStart_run$SLURM_JOB_ID"  # unique per job
...
rm data
mv data_debug_adv30_from_start data
