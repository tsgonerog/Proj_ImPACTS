...
# are a pair; see tools/tapenade_profiling/README.md.
...
#
#     IMPACTS_DURATION_DAYS=180 ../../../tools/submit.sh submit_tapAdj_tapProfile.sh
#
simulation_duration_with_dT1800_days="${IMPACTS_DURATION_DAYS:-30}"
