...
#
# THE DEFAULT adjoint submit script since 2026-09-02: ./submit_tapAdj.sh is a
# symlink to this file (and ./build_tapAdj.sh to build_tapAdj_nocheckpoint.sh).
# Identical to submit_tapAdj_ckpAll.sh except for the executable it copies: the
# nocheckpoint build recomputes less and stores more inside each time step
# (see build_tapAdj_nocheckpoint.sh). Build and submit script are a pair.
# Run it with ../../../tools/submit.sh so the per-machine sbatch flags are added.
#

#SBATCH -J DINO_1deg_tapAdj_nocheckpoint  # Set main part of the job name once here
...
#
#     IMPACTS_DURATION_DAYS=3660 ../../../tools/submit.sh submit_tapAdj_nocheckpoint.sh
#
...
build_dir="$base_dir/build_tapAdj_nocheckpoint"
