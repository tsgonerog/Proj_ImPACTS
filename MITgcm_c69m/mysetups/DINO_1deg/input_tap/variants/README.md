...
| [`adjointViscosity/`](adjointViscosity/) | `data.autodiff` with adjoint-mode viscosity inflation (`viscFacInAd = 10.`). **Needs the matching build and submit script** — `build_tapAdj_adjVisc.sh` + `submit_tapAdj_adjVisc.sh` |
