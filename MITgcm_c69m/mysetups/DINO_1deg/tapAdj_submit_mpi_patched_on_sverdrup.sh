...
#SBATCH -J DINO_1deg_tapAdj     # Set main part of the job name once here
...
test_cases="frm180yPk-vAhD-vAhZ-2p00"
...
build_dir="$base_dir/build_tapAdj_mpi_patched"
run_dir="/scratch2/tshahriar/DINO_1deg_tapAdj_runs/${job_name}_${simulation_duration_with_dT1800_days}d${suffix}_run$SLURM_JOB_ID"  # unique per job
...
mpirun -n $SLURM_NTASKS ./mitgcmuv_tap_adj > output_tap_adj.txt 2>&1
