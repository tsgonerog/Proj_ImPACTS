...
# setup's Tapenade options file, which adds code_tap/flow_tap_local after
# the stock external library (relative paths resolve because genmake2 and
# Tapenade both run in the build directory).
