...
C       >= 1 (and useSEAICEinAdMode)    : omit pieces of seaice thermo adjoint
      ...
      INTEGER inSEAICEadjMODE, outSEAICEadjMODE
      COMMON /AUTODIFF_PARM_I/
     &       dumpAdVarExch, mon_AdVarExch, SEAICEapproxLevInAd
     &      ,inSEAICEadjMODE, outSEAICEadjMODE
...
CAB   Factor for left over h from regulation
      _RL SIregFacInAd, SIregFacInFw
      _RL inAdviscA4Grid, inAdviscAhGrid, inAdviscArNr
C      _RL inAddiffKrNrT, inAddiffKrNrS
      _RL inAddiffKhT, inAddiffKhS
      _RL inAddiffK4T, inAddiffK4S
      _RL outAdviscA4Grid, outAdviscAhGrid, outAdviscArNr
C      _RL outAddiffKrNrT, outAddiffKrNrS
      _RL outAddiffKhT, outAddiffKhS
      _RL outAddiffK4T, outAddiffK4S

      COMMON /AUTODIFF_PARM_R/
     &  viscFacInAd, viscFacInFw, SIregFacInAd, SIregFacInFw
     & ,inAddiffKhT, inAddiffKhS,
     &  inAddiffK4T, inAddiffK4S,
     &  outAddiffKhT, outAddiffKhS,
     &  outAddiffK4T, outAddiffK4S
     & ,inAdviscA4Grid, inAdviscAhGrid, inAdviscArNr,
     &  outAdviscA4Grid, outAdviscAhGrid, outAdviscArNr
C     &  inAddiffKrNrT, inAddiffKrNrS,
C     &  outAddiffKrNrT, outAddiffKrNrS,
