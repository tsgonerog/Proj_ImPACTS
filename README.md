...
│   ├── build_tapAdj_adjViscBoost.sh     │  default (_nocheckpoint since 2026-09-02)
...
│   ├── submit_tapAdj_adjViscBoost.sh    │  directories; submit_tapAdj.sh is the matching
│   └── submit_tapAdj_tapProfile.sh     ─┘  symlink
│
